...
public class  ActivityMiniRecog extends AppCompatActivity implements EventListener {
    ...
    private void start() {
        ...
        //arams.put(SpeechConstant.NLU, "enable");
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //加入自己的按钮，回到调用它的Activity处
        Button buttonFinish = (Button) findViewById(R.id.btn_finish);
        buttonFinish.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent();
                intent.putExtra("data_return", txtLog.getText());
